---
title: "Social Science in the Age of AI"
...
<br>
<br>
Use the link below or scan QR code to access page.

[sgsssonline.github.io](https://sgsssonline.github.io/genai-guidance/gpts.html)
:::
...
Use the Teams chat to share your views (positive or negative) and any concerns about genAI.
...
- Philosophically speaking... [ChatGPT is bullshit](https://link.springer.com/article/10.1007/s10676-024-09775-5).
- Most of the hype relies upon 'techno-magic tricks' that [AI literacy helps dispell](https://journals.sagepub.com/doi/10.1177/00222429251314491).
- Even those working in AI, such as [Gary Marcus](https://garymarcus.substack.com/), are highly critical of the claims being made.
- In contrast to claims of 2x (or more!) increases in coding productivity with genAI, research is finding [programmers are *slower* when using genAI](https://www.reuters.com/business/ai-slows-down-some-experienced-software-developers-study-finds-2025-07-10/).

## My Position

GenAI is **massively** overhyped. It has its uses, but in many cases, using pre-existing tools and resources - including 'traditional' forms of AI - remain the clear superior option.

There is huge potential with genAI. However, the intent behind how genAI is being developed and deployed is pushing us towards a particular form of genAI based on the unholy trinity of late stage capitalism - productivity, convenience, immediacy.
...
- Going beyond simple "use responsibly" lists of dos and don'ts.
- (What 'responsible use' is there of a technology being developed and deployed irresponsibly?)
...
An issue arises though when the technical/practical is excluded and treated as distinct and separate from the conceptual...

## Conceptual Problems

When the conceptual and practical treated as separate, academic positions on genAI risk sharing same impoverished 'technology vs culture' view as the tech bros:
...
## Example with 'Thinking' Model {.smaller}
...
In most cases, study modes are merely [poorly written prompts](https://github.com/asgeirtj/system_prompts_leaks/blob/main/OpenAI/Study%20and%20learn.md).
...
"Capital is dead labour, which, vampire-like, lives only by sucking living labour, and lives the more, the more labour it sucks." Marx, Capital vol. 1

GenAI companies are investing huge amounts of time and effort into a very particular form of genAI.

The false promise of genAI is replacing vampiric capitalism with necromanic capitalism - reanimated labour as a service.

The default behaviours are not how all potential forms of genAI could behave. Even the back-and-forth chat behaviour is trained, sculpted, and shaped...
...
## A Biased Understanding of Bias

GenAI companies claim they are making models less 'biased' and are creating ways to [define and evaluate political bias in genAI models](https://openai.com/index/defining-and-evaluating-political-bias-in-llms/). However, much of this is questionable:

- Being driven by Trump administration's attack on DEI and 'wokeness'.
- 'Invaliating' the user's views is treated by OpenAI as 'bias'.
- Non-bias is often flawed 'both-sideism' that undermines strength of evidence and there being more than two sides.
- More critical points often seem to be absent in the desired 'non-biased' examples.
...
## Inconvenient Mediation

"There is nothing, nothing in heaven, or in nature or in mind or anywhere else which does not equally contain both immediacy and mediation." G. W. F. Hegel

GenAI as situated technology is mediated through the relations and processes of how  it is developed, deployed, and used.

The layers of mediation are increasing and thickening - **and** genAI is a mediary, its responses are not neutral and it is increasingly being pushed as 'agent' that will do things for you.

(False) notion of genAI as a 'universal mediary' - a personal tailored assistance for everyone.

## GenAI Mediates Power Relations {.smaller}

"It is this last part of the handicraftsman’s implement that is first seized upon by the industrial revolution, leaving to the workman, in addition to his new labour of watching the machine with his eyes and correcting its mistakes with his hands, the merely mechanical part of being the moving power." Marx, Capital vol. 1

GenAI companies love to claim we will all become 'supervisors' to AI agents.

As with industrial revolution, where workers became 'supervisors' to machines, the form this is taking is instead a degradation of work - a 'tool' used by capital against labour.

Worse, [workers are having to correct genAI mistakes](https://www.bloodinthemachine.com/p/ai-killed-my-job-translators), which can take more time yet receives less pay because of the false narrative that genAI increases productivity.

Various companies are making [genAI use mandatory](https://www.businessinsider.com/microsoft-internal-memo-using-ai-no-longer-optional-github-copilot-2025-6), dismissing worker complaints that it is not up to the job and actually reducing productivity.
...
[AI Writing conforms to a particular style](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing) that makes copy/paste AI text obvious and isn't good writing.
...
With some use-cases then, it is worth considering files, web-browsing, and/or data.
...
[Example with all three volumes of Capital and Grundrisse](https://notebooklm.google.com/notebook/472ab366-dcfb-4826-8d05-e28bd5ca5684).
...
Giving genAI access to web, files, and data is often promoted as way to solve all its problems. That is far from being the case.

[BBC report](https://www.bbc.co.uk/mediacentre/2025/new-ebu-research-ai-assistants-news-content) - "Largest study of its kind shows AI assistants misrepresent news content 45% of the time time - regardless of language or territory". 

[Posit report](https://posit.co/blog/introducing-bluffbench/) - "When plotting, LLMs see what they expect to see".

[Article in Royal Society Open Science](https://royalsocietypublishing.org/rsos/article/12/4/241776/235656/Generalization-bias-in-large-language-model) - "Generalization bias in large language model summarization of scientific research".
...
Can you think situations where file upload and/or web search could improve/worsen responses?
