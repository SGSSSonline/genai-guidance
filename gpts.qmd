...
This section contains custom GPTs I have setup to demonstrate different genAI use-cases. These GPTs are a mix of ones I have created for students in specific contexts, ones I use myself, and ones to demonstrate a point. You may find some useful, others - such as [Academic Exercises in Style](gpts/academic-exercises.qmd) - that are more to demonstrate a point will be less directly useful, but still illustrate what is possible.
